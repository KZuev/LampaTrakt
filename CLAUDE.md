...
**v3.2.14** — Дата цифрового релиза в карточке: если релиз ещё не вышел, вместо даты показывается «Скоро» (`trakttv_soon`). Дата отображается только для уже вышедших релизов.
...
| v3.2.14 | TBD | Дата цифрового релиза в карточке: если релиз в будущем — показывается «Скоро» (`trakttv_soon`) вместо даты; дата выводится только для уже вышедших |
