...
**v3.0.33** — Гостевой вход: Да/Нет в subtitle; пометка у авторизованного слота-гостя.
...
| v3.0.33 | TBD | Гостевой вход: subtitle Да/Нет; пометка у авторизованного слота-гостя |
