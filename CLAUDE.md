...
**v3.0.9** — Авто торрент: оверлей с живым статусом и спиннером; фикс teardown при отсутствии торрента.
...
| v3.0.9  | TBD       | Авто торрент: оверлей «Ищем…» со спиннером и живым статусом; фикс teardown при `best==null` |
