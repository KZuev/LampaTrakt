...
**v3.1.5** — Копирование лога на iPhone: кнопка «Открыть для копирования (iPhone)» в «История отметок» открывает `<textarea>` с последними 10 записями лога, сфокусированный — iPhone Remote показывает клавиатуру для копирования. Только на Apple TV (`Platform.tv()`).
...
| v3.1.5 | TBD | Копирование лога на iPhone: «Открыть для копирования (iPhone)» в «История отметок» → `<textarea>` с 10 последними записями, авто-фокус, только на Apple TV |
