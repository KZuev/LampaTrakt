  ...
  function updateTraktAccountSwitchBadge() {
    try {
      ...
      if (authed.length === 0) {
        ...
        badge.text('✕').removeClass('trakt-account-badge--multi').addClass('trakt-account-badge--cross');
        return;
      }
