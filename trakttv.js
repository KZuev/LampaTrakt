  ...
  function updateTraktAccountSwitchBadge() {
    try {
      ...
      if (authed.length === 0) {
        ...
        badge.text('✕').removeClass('trakt-account-badge--multi trakt-account-badge--multiwatch').addClass('trakt-account-badge--cross');
        return;
      }
      ...
      badge.text(active + 1);
      badge.removeClass('trakt-account-badge--multi trakt-account-badge--multiwatch');
    } catch (e) {}
  }
