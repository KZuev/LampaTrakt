(function () {
  ...
  function updateTraktAccountSwitchBadge() {
    try {
      var n = multiAccountGetActiveSlot() + 1;
      $('.trakt-account-badge').text(n);
    } catch (e) {}
  }
  function initTraktAccountSwitchButton() {
    try {
      ...
      var slotNum = multiAccountGetActiveSlot() + 1;
      var btn = Lampa.Head.addIcon(
        '<span class="trakt-head-icon">' + iconSvg + '<span class="trakt-account-badge">' + slotNum + '</span></span>',
