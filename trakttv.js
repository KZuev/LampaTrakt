    ...
    if (isLampa3 && Lampa.Maker) {
      ...
      comp.use({
        ...
        onController: function onController(controller) {
          var origToggle = controller.toggle || function(){};
