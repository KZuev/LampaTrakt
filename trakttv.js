(function () {
  ...
  function _patchLampaCard() {
    ...
    Lampa.Card = function(data, params) {
      var inst;
      try { inst = new _orig(data, params); } catch(e) { inst = _orig.apply(this, arguments); if (!inst) inst = this; }
    ...
    Lampa.Card.prototype = _orig.prototype;
