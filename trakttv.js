      ...
      comp.use({
        onCreate: function onCreate() {
          ...
          Api$2[type](params).then(function (data) {
            ...
            try { var _sbRoot = _this.html && _this.html[0]; if (_sbRoot) { var _sbEl = _sbRoot.querySelector('.scroll__body'); if (_sbEl) _sbEl.style.paddingTop = (type === 'watchlist') ? '0' : '44px'; } } catch(e) {}
      ...
      comp.use({
        onCreate: function onCreate() {
          ...
          Api$2[apiMethod](params).then(function (data) {
            ...
            try { var _sbRoot = _this9.html && _this9.html[0]; if (_sbRoot) { var _sbEl = _sbRoot.querySelector('.scroll__body'); if (_sbEl) _sbEl.style.paddingTop = '44px'; } } catch(e) {}
