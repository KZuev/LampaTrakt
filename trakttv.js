(function () {
  ...
  function watchlistHub(object) {
    ...
    function makeBtn(label) {
      ...
      btn.find('.trakt-watchlist__sort-label').css({ 'width': '100%', 'text-align': 'center', 'white-space': 'nowrap', 'margin-left': '0', 'overflow': 'hidden', 'text-overflow': 'ellipsis' });
      return btn;
    }
