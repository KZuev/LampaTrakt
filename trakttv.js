              ...
              Lampa.Select.show({
                ...
                onSelect: function (a) {
                  if (a.action === 'toggle_avatar') {
                    multiAccountUpdateSlot(slotIndex, { show_avatar: !(d && d.show_avatar) });
